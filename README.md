...
> Tamper-evident query logger storing cryptographic hash chains inside local SQLite instances.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/auditrag/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-auditrag.git
cd tp-auditrag
```
...
```bash
kubectl port-forward deployment/tp-auditrag 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── immutable_log.py     # Main configuration file
```
...
---
*Generated by [AuditRAG Studio](https://pradeeptalari14.github.io/portfolio/tools/auditrag/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
